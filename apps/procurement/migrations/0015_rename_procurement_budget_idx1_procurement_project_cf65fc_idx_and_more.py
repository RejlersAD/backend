...
# FIXED: Use conditional SQL to avoid failures when legacy indexes are missing
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('procurement', '0014_alter_purchaserequisition_ai_vendor_recommendations_and_more'),
    ]
