"""
Relabels 'valve_types' from "Manual Values" to "Manual Valves" (typo fix
from the previous rename) — id unchanged, only the display label. Updates
the seeded legend row's `name` prefix to match; description/definition
untouched.
...
SECTION = 'valve_types'
OLD_NAME = 'Manual Values — Valve Type (default)'
NEW_NAME = 'Manual Valves — Valve Type (default)'
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('instrument_io_workflow', '0048_relabel_valve_types_to_manual_valves'),
    ]
