"""
Relabels 'equipment_register' to "Equipment Numbering" (from "Main
Equipment", set in migration 0024) — id unchanged, only the display label.
Updates the seeded legend row's `name` prefix to match; description/
...
OLD_NAME = 'Main Equipment — XX-XX-AAAA-XX-XX-XX (default)'
NEW_NAME = 'Equipment Numbering — XX-XX-AAAA-XX-XX-XX (default)'
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('instrument_io_workflow', '0029_relabel_equipment_register_v2'),
    ]
