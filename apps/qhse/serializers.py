...
class QHSERunningProjectSerializer(serializers.ModelSerializer):
    ...
    srNo = serializers.IntegerField(source='sr_no', read_only=True)
    projectNo = serializers.CharField(source='project_no')
    projectTitle = serializers.CharField(source='project_title')
    projectTitleKey = serializers.CharField(source='project_title_key', allow_blank=True, allow_null=True)
    client = serializers.CharField()
    projectManager = serializers.CharField(source='project_manager')
    projectStartingDate = serializers.DateField(source='project_starting_date')
    projectClosingDate = serializers.DateField(source='project_closing_date')
    projectExtension = serializers.DateField(source='project_extension', allow_null=True)
    projectQualityEng = serializers.CharField(source='project_quality_eng')
    manHourForQuality = serializers.DecimalField(source='man_hour_for_quality', max_digits=10, decimal_places=2)
    manhoursUsed = serializers.DecimalField(source='manhours_used', max_digits=10, decimal_places=2)
    manhoursBalance = serializers.DecimalField(source='manhours_balance', max_digits=10, decimal_places=2, read_only=True)
    qualityBillabilityPercent = serializers.CharField(source='quality_billability_percent')
    projectQualityPlanStatusRev = serializers.CharField(source='project_quality_plan_status_rev', allow_blank=True, allow_null=True)
    projectQualityPlanStatusIssueDate = serializers.DateField(source='project_quality_plan_status_issue_date', allow_null=True)
    projectAudit1 = serializers.DateField(source='project_audit_1', allow_null=True)
    projectAudit2 = serializers.DateField(source='project_audit_2', allow_null=True)
    projectAudit3 = serializers.DateField(source='project_audit_3', allow_null=True)
    projectAudit4 = serializers.DateField(source='project_audit_4', allow_null=True)
    clientAudit1 = serializers.DateField(source='client_audit_1', allow_null=True)
    clientAudit2 = serializers.DateField(source='client_audit_2', allow_null=True)
    delayInAuditsNoDays = serializers.IntegerField(source='delay_in_audits_no_days')
    carsOpen = serializers.IntegerField(source='cars_open')
    carsDelayedClosingNoDays = serializers.IntegerField(source='cars_delayed_closing_no_days')
    carsClosed = serializers.IntegerField(source='cars_closed')
    obsOpen = serializers.IntegerField(source='obs_open')
    obsDelayedClosingNoDays = serializers.IntegerField(source='obs_delayed_closing_no_days')
    obsClosed = serializers.IntegerField(source='obs_closed')
    projectKPIsAchievedPercent = serializers.CharField(source='project_kpis_achieved_percent')
    projectCompletionPercent = serializers.CharField(source='project_completion_percent')
    rejectionOfDeliverablesPercent = serializers.CharField(source='rejection_of_deliverables_percent', allow_blank=True, allow_null=True)
    costOfPoorQualityAED = serializers.DecimalField(source='cost_of_poor_quality_aed', max_digits=15, decimal_places=2)
